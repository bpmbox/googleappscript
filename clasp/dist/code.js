...
!function(e, a) {
    ...
    var onOpen = function() {
        SpreadsheetApp.getUi().createMenu("My Sample React Project").addItem("Sheet Editor", "openDialog").addItem("Sheet Editor (Bootstrap)", "openDialogBootstrap").addItem("About me", "openAboutSidebar").addItem("Open Chat", "OpenChat").addToUi();
    }, openDialog = function() {
    ...
    __webpack_require__.r(__webpack_exports__), function(global) {
        ...
        global.onOpen = _ui__WEBPACK_IMPORTED_MODULE_0__["b"], global.openDialog = _ui__WEBPACK_IMPORTED_MODULE_0__["d"], 
        global.openDialogBootstrap = _ui__WEBPACK_IMPORTED_MODULE_0__["e"], global.openAboutSidebar = _ui__WEBPACK_IMPORTED_MODULE_0__["c"], 
